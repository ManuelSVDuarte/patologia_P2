// Array contendo todos os casos clínicos e suas respectivas imagens
const casosClinicos = [
    {
        numero: 1,
        imagem: "lamina 1.jpg",
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    casosEmbaralhados.forEach((caso, index) => {
        ...
        // Estilo embutido básico para garantir que a imagem não quebre o layout
        divCaso.innerHTML = `
            <div style="background: #fff; padding: 20px; margin-bottom: 30px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
                <h2 style="color: #0056b3; margin-bottom: 15px;">Questão ${index + 1}</h2>
                ...
                <p style="font-size: 1.1rem; line-height: 1.5; color: #333;"><strong>História Clínica:</strong> ${caso.texto}</p>
            </div>
        `;
